...
namespace HackerRankWeek3
{
    class Program
    {
        ...
        static void TestIceCreamParlor1()
        {
            ...
            int money = 6;
            Console.WriteLine(String.Join(",", Result.icecreamParlor(money, prices)));
            Console.WriteLine("Expected: 1, 4");


            prices = new List<int>() { 1, 4, 5, 3, 2 };
            money = 4;
            Console.WriteLine(String.Join(",", Result.icecreamParlor(money, prices)));
            Console.WriteLine("Expected: 1, 4");

            prices = new List<int>() { 2, 2, 4, 3 };
            money = 4;
            Console.WriteLine(String.Join(",", Result.icecreamParlor(money, prices)));
        ...
        static void TestIceCreamParlor2()
        {

            TextWriter textWriter = new StreamWriter(Directory.GetCurrentDirectory()+"\\output1.txt", true);
            StreamReader sr = new StreamReader(Directory.GetCurrentDirectory() + "\\testecase1.txt");

            int t = Convert.ToInt32(sr.ReadLine().Trim());

            for (int tItr = 0; tItr < t; tItr++)
            {
                int m = Convert.ToInt32(sr.ReadLine().Trim());
